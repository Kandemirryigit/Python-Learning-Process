...
api_key="af83a9a5d007731a3e388b51e6e4b4b8"  # your own weather API key should be here
...
if weather_status<=804 and weather_status>=801:
      kit.sendwhatmsg_instantly("+905346246409","Today the weather is cool just a little bit cloud.")
elif weather_status==800:
      kit.sendwhatmsg_instantly("+905346246409","Today the weather is cool.")
elif weather_status<=699 and weather_status>=600:
    kit.sendwhatmsg_instantly("+905346246409","I see snow in the weather.I recommend you to take your umbrella.")
elif weather_status<=599 and weather_status>=500:
     kit.sendwhatmsg_instantly("+905346246409","I see rain in the weather.I recommend you to take your umbrella.")
elif weather_status<=399 and weather_status>=300:
      kit.sendwhatmsg_instantly("+905346246409","I see light rain in the weather.You don't have to take your umbrealla if you wanna feel the rain.")
elif weather_status<=299 and weather_status>=200:
      kit.sendwhatmsg_instantly("+905346246409","I see Thunderstorm in the weather.I recommend that you not go outside.")
