...
img = Image.open("C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/blue.png") # Image's path
...
def button():
    ...
    api_key_location = "zlnYW1VXDN9SEpd8IsBoOv39lwZxYHNN2lCnCNDWL3FEDw6lgM5Oa1Ke45Q4yxoW"  # your own location API key should be here
    ...
    api_key_weather = "c6b236f1d743dc003864ed48947982ad"  # Your own weather API key should be here
    ...
    api_key_time = "DUNEOPDFZMP3"  # Your own time API key should be here
    ...
    if weather_id_now >= 200 and weather_id_now <= 232:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/thunderstorm.jpg"
    elif weather_id_now >= 300 and weather_id_now <= 321:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/drizzle.jpg"
    elif weather_id_now >= 500 and weather_id_now <= 531:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/rain.jpg"
    elif weather_id_now >= 600 and weather_id_now <= 622:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/snow.jpg"
    elif weather_id_now >= 701 and weather_id_now <= 781:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/fog.jpg"
    elif weather_id_now == 800:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/clear.jpg"
    elif weather_id_now >= 801 and weather_id_now <= 804:
        image_path = "C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/clouds.jpg"
...
# To create an image
search_image = Image.open("C:/Users/CASPER/Desktop/python_projects/Weather App with tkinter/images/search button.jpg")  
